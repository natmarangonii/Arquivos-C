// Natalia Marangoni e Letícia Doff
#include <stdio.h>
#include <stdlib.h>
#include "clientes.h"
#include "locacoes.h"
    ...
    do {
        ...
        switch(opcao) {
            ...
            case 5:
                ...
                scanf("%d", &idClientes);
                buscarLocacoesPorCliente(locacoes, totalLocacoes, idClientes);
                break;
            case 6:
                printf("Digite o ID do cliente: ");
                scanf("%d", &idClientes);
                buscarClientePorID(clientes, totalClientes, idClientes);
                break;
            case 0:
            system ("clear");
